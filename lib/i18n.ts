...
export const dictionaries = {
  en: {
    ...
    workbench: {
      ...
      zoomOut: 'Zoom out',
      zoomIn: 'Zoom in',
      cropImageTitle: 'Crop captured image',
      cropImageDescription: 'Scroll the preview, drag the crop sliders, and save only the part you need.',
      cropTop: 'Top',
      cropBottom: 'Bottom',
  ...
  ko: {
    ...
    workbench: {
      ...
      zoomOut: '축소',
      zoomIn: '확대',
      cropImageTitle: '캡처 이미지 자르기',
      cropImageDescription: '미리보기를 스크롤하고 자르기 슬라이더를 드래그해서 필요한 구간만 저장하세요.',
      cropTop: '위쪽',
      cropBottom: '아래쪽',
