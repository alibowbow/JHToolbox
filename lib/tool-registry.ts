...
export const tools: ToolDefinition[] = [
  ...
  },
  {
    ...
    name: 'PDF Compress',
    category: 'pdf',
    description: 'Shrink PDF size by downsampling and re-encoding page images.',
    accept: '.pdf',
    tags: ['pdf', 'compress'],
  ...
  },
  {
    ...
    name: 'PDF to Excel',
    category: 'pdf',
    description: 'Extract readable PDF text into workbook sheets.',
    accept: '.pdf',
  ...
  },
  {
    ...
    name: 'Sign PDF',
    category: 'pdf',
    description: 'Apply a visual signature stamp to a PDF page.',
    accept: '.pdf,.png,.jpg,.jpeg,.webp',
    multiple: true,
  ...
  },
  {
    ...
    name: 'Repair PDF',
    category: 'pdf',
    description: 'Rebuild a parseable PDF into a cleaner browser-saved copy.',
    accept: '.pdf',
