...
export const tools: ToolDefinition[] = [
  ...
  },
  {
    ...
    name: 'Edit PDF',
    category: 'pdf',
    description: 'Add text, image overlays, comments, or highlight boxes to a PDF page.',
    accept: '.pdf,.png,.jpg,.jpeg,.webp',
    multiple: true,
  ...
  {
    id: 'pdf-sign',
    name: 'Add Visual Signature',
    category: 'pdf',
    description: 'Apply a visual signature stamp to a PDF page. This is not a cryptographic/certificate-based digital signature.',
    accept: '.pdf,.png,.jpg,.jpeg,.webp',
    multiple: true,
  ...
  },
  {
    ...
    name: 'Compare PDF',
    category: 'pdf',
    description: 'Compare two PDFs by extracted text and generate a readable diff report.',
    accept: '.pdf',
    multiple: true,
    tags: ['pdf', 'compare', 'diff'],
    browseGroups: ['new'],
    options: [
      { key: 'ignoreWhitespace', label: 'Ignore whitespace', type: 'checkbox', defaultValue: true },
    ],
  },
  {
    id: 'pdf-to-pdfa',
    ...
    options: [
      ...
      { key: 'subject', label: 'Subject', type: 'text', defaultValue: 'Archival browser export' },
    ],
  },
  {
    id: 'pdf-to-hwpx',
  ...
  },
  {
    ...
    name: 'Audio Recorder',
    category: 'audio',
    description: 'Record the microphone or, on a computer, only the device sound in full quality, then edit and export WAV or MP3.',
    accept: '*',
    tags: ['audio', 'microphone', 'record', 'system audio'],
    browseGroups: ['new', 'capture', 'editor-enabled'],
    inputMode: 'capture',
    previewKind: 'audio',
    options: [
  ...
  },
  {
    ...
    category: 'web',
    description: 'Capture a full-scroll webpage from a URL into a PDF. The page is rasterized — text and links in the PDF are not selectable.',
    accept: '*',
    tags: ['url', 'pdf', 'web'],
    inputMode: 'url',
    browseGroups: ['capture'],
...
export const categories: ToolCategoryDefinition[] = [
  ...
  },
  {
    id: 'audio',
    label: 'Audio Editor',
    description: 'Trim, record, edit, and batch convert audio in a browser-first workflow.',
    tools: [
      'audio-cut',
      'audio-recorder',
      'audio-merge',
