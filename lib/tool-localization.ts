...
const koToolNames: Record<string, string> = {
  ...
  'webp-jpg': 'WEBP를 JPG로',
  'jpg-webp': 'JPG를 WEBP로',
  'gif-jpg': 'GIF 첫 프레임을 JPG로',
  'gif-png': 'GIF 첫 프레임을 PNG로',
  'tiff-jpg': 'TIFF를 JPG로',
  'tiff-png': 'TIFF를 PNG로',
  'svg-png': 'SVG를 PNG로',
...
const koToolDescriptions: Record<string, string> = {
  ...
  'pdf-reduce-size': 'PDF 용량을 줄입니다. "텍스트 유지"는 내장된 JPEG 이미지만 재압축해 텍스트 선택을 유지합니다(권장). "플래튼"은 페이지 전체를 이미지로 다시 렌더링해 더 작지만 텍스트 선택이 불가능해집니다. 더 작아지지 않으면 원본을 그대로 둡니다.',
  ...
  'gif-jpg': 'GIF의 첫 프레임을 JPG로 변환합니다 (애니메이션은 보존되지 않습니다).',
  'gif-png': 'GIF의 첫 프레임을 PNG로 변환합니다 (애니메이션은 보존되지 않습니다).',
  ...
  'audio-convert': '여러 오디오 파일을 한 번에 MP3, WAV, M4A, AAC로 변환합니다.',
  'audio-cut': '파형을 보며 구간을 자르고 통합 오디오 에디터로 이어집니다.',
  ...
  'url-pdf': '웹 페이지 전체 스크롤을 PDF로 저장합니다. 래스터 이미지라 PDF의 텍스트·링크는 선택할 수 없습니다.',
...
Object.assign(koToolDescriptions, {
  ...
  'image-upscale': '고품질 Lanczos 리샘플링으로 확대합니다. AI 초해상도가 아니라 기존 픽셀을 보간합니다.',
  ...
  'video-trim': '비디오에서 필요한 구간만 잘라냅니다.',
...
Object.assign(koToolDescriptions, {
  ...
  'pdf-sign': '텍스트 또는 이미지 서명을 PDF 페이지에 시각적으로 배치합니다. 암호학적·인증서 기반 전자서명이 아닙니다.',
